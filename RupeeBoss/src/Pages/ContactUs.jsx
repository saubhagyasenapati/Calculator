...
const [number, setNumber] = useState('');
  ...
  const handleSubmit = (e) => {
    ...
    .catch(error => {
     ...
     if(error){
      toast.warn('There is some error from our end feel free to contact us at wecare@rupeeboss.com', {
        position: "top-right",
        autoClose: 5000,
        hideProgressBar: false,
        closeOnClick: true,
       ...
       <p className="title">Get in Touch</p>
        ...
        <div className="contactus">
          <form action="" onSubmit={handleSubmit}>
            ...
            <input type="number" name="number" id="" placeholder="Number"  value={number} onChange={(e) => setNumber(e.target.value)} />
